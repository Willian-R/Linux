...
pacman -S xorg xfce4 libreoffice xfce4-goodies xdg-user-dirs gvfs lightdm lightdm-gtk-greeter lightdm-gtk-greeter-settings firefox vlc gtkmm3 nvidia nvidia-libgl mesa papirus-icon-theme networkmanager pulseaudio bash-completion octave pycharm-community-edition neofetch archlinux-wallpaper --noconfirm
...
# Ativa Network Manager e o lightdm
